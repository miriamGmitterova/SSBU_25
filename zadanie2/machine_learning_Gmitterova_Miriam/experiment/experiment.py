...
class Experiment:
    ...
    def plot_precision_graph(self):
        """Vykresli graf pre Precision počas replikácií."""
        # Načítaj dáta zo súboru CSV
        data = pd.read_csv("outputs/model_accuracies.csv")

        # Graf pre Precision počas replikácií
        # plt.figure(figsize=(10, 6))
        # plt.plot(data["Replication"], data["precision"], marker='o', label="precision", color='green')
        # plt.title("Precision during Replications")
